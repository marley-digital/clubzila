                    ...
                    <div class="form-group margin-zero">
                      ...
                      <div class="col-sm-10">
                      	<select name="update_length" class="form-control">
                            ...
                            <option @if( $settings->update_length == 30000 ) selected="selected" @endif value="30000">30000 {{ trans('admin.characters') }}</option>
                            <option @if( $settings->update_length == 100000 ) selected="selected" @endif value="100000">100000 {{ trans('admin.characters') }}</option>
                          </select>
