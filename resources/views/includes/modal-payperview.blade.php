				...
				<div class="card bg-white shadow border-0">
					...
					<div class="card-body px-lg-5 py-lg-5 position-relative">
						...
						<form method="post" action="{{url('send/ppv')}}" id="formSendPPV">
							...
							<div class="custom-control custom-radio mb-3">
								<input name="payment_gateway_ppv" @if (Helper::userWallet() == 0)  @endif value="wallet" id="ppv_radio0" class="custom-control-input" type="radio">
						...
						@endif
							<div class="custom-control custom-radio mb-3">
								<input name="payment_gateway_ppv"  value="mobile" id="ppv_radio1" class="custom-control-input" type="radio">
								<label class="custom-control-label" for="ppv_radio1">
									<span>
										<strong>
										<i class="fas fa-mobile mr-1 icon-sm-radio"></i> Mobile Money
										<span class="w-100 d-block font-weight-light">
										Pay with direct from vodacom, tigo and airtel</span>
