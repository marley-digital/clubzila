...
$(document).ready(function(){
	...
	if ($('#contentLocked').hasClass('unlock')) {
		$('#updateDescription').keyup();
		$('.promotext-div').html('');
	} else {
		$('.promotext-div').html('<div class="input-group-prepend"><span class="input-group-text">'+placeholder_text+'</span></div><textarea class="form-control" id="promotext" name="promotext"  aria-label="With textarea"></textarea>');
	}
...
$(document).on('click','#avatar_file',function () {
	...
	$('.updateDescription').on('keyup', function() {
            ...
            var locked = $(this).parents('form').find('.customCheckLocked').prop('checked');
		if (locked) {
			var promotext = $(this).parents('form').find('#promotext').val();
		}
		console.log('locked',locked);
		console.log('promotext',promotext);
			if (trim(element).length >= 1 && locked && trim(promotext).length >= 1) {
				$(this).parents('form').find('.btnEditUpdate').removeAttr('disabled').removeClass('e-none');
				return false;
			} else if(trim(element).length >= 1 && locked==false) {
				$(this).parents('form').find('.btnEditUpdate').removeAttr('disabled').removeClass('e-none');
				return false;
			}
			 else {
	...
	$('#updateDescription').on('keyup', function() {
            ...
            var locked = $('#customCheckLocked').prop('checked');
    		if ($('#customCheckLocked').prop('checked')) {
    			var promotext = $('#promotext').val();
    		}
			if (trim(element).length >= 1 && trim(element).length <= maximum && locked && trim(promotext).length >= 1) {
				$('#btnCreateUpdate, #btnEditUpdate').removeAttr('disabled').removeClass('e-none');
				return false;
			} else if(trim(element).length >= 1 && trim(element).length <= maximum && locked==false) {
			    $('#btnCreateUpdate, #btnEditUpdate').removeAttr('disabled').removeClass('e-none');
				return false;
			}
			else {
		...
		$(document).on('keyup','#promotext',function()
		{
			//alert();
			$('#updateDescription').keyup();
		});
		...
		{
			//alert();
			$(this).parents('form').find('.updateDescription').keyup();
		});
	  ...
	  //<<==================== END PAGINATOR UPDATES
		...
		$('#contentLocked').on('click', function() {
		  ...
		  if ($(this).hasClass('unlock')) {
		     ...
		     $('.promotext-div').html('<div class="input-group-prepend"><span class="input-group-text btn-primary text-white">'+placeholder_text+'</span></div><textarea class="form-control" id="promotext" name="promotext" placeholder="'+placeholder_text+'"  aria-label="With textarea"></textarea>');
		  ...
		  if(($(this).parents('form').find('input[name=price]').hasClass('active')))
		  {
			$('.promotext-div').html('<div class="input-group-prepend"><span class="input-group-text btn-primary text-white">'+placeholder_text+'</span></div><textarea class="form-control" id="promotext" name="promotext" placeholder="'+placeholder_text+'"  aria-label="With textarea"></textarea>');
		  }
		});
		...
		$(document).on('click','.contentLocked', function() {
		  if ($(this).hasClass('unlock')) {
                ...
                var promotext = $(this).parents('form').find('.promotext-div-update').attr('data-value');
				$(this).parents('form').find('.promotext-div-update').html('<div class="input-group-prepend"><span class="input-group-text btn-primary text-white" >'+placeholder_text+'</span></div><textarea class="form-control" placeholder="'+placeholder_text+'" id="promotext" name="promotext" value="'+promotext+'" aria-label="With textarea">'+promotext+'</textarea>');
		     $(this).html('<i class="feather icon-lock" style="font-size:25px;"></i>').removeClass('unlock');
		  } else {
		     $(this).parents('form').find('.customCheckLocked').trigger('click');
             $(this).parents('form').find('.promotext-div-update').html('');
		     $(this).html('<i class="feather icon-unlock" style="font-size:25px;"></i>').addClass('unlock');
		  }
		  if(($(this).parents('form').find('input[name=price]').hasClass('active')))
		  {
 ...
 $(document).on('click','.sendReport', function(e){
	...
	$(document).ready(function() {
	 ...
	 $(document).on('click','#setPrice',function () {
		...
		if (input.hasClass('active')) {
			$('#updateDescription').keyup();
			$('.promotext-div').html('<div class="input-group-prepend"><span class="input-group-text btn-primary text-white">'+placeholder_text+'</span></div><textarea class="form-control" id="promotext" placeholder="'+placeholder_text+'" name="promotext"  aria-label="With textarea"></textarea>');
			
		} else if($(this).parents('form').find('#contentLocked').hasClass('unlock')) {
			$('.promotext-div').html('');
		}
 	});
	...
	$(document).on('click','.setPrice',function () {
	 ...
	 if (input.hasClass('active')) {
		...
		$('#updateDescription').keyup();
		var promotext = $(this).parents('form').find('.promotext-div-update').attr('data-value');
		$(this).parents('form').find('.promotext-div-update').html('<div class="input-group-prepend"><span class="input-group-text btn-primary text-white">'+placeholder_text+'</span></div><textarea class="form-control" id="promotext" placeholder="'+placeholder_text+'" name="promotext" value="'+promotext+'" aria-label="With textarea">'+promotext+'</textarea>');
		
	} else if($(this).parents('form').find('.contentLocked').hasClass('unlock')){
		$('.promotext-div-update').html('');
	}
 });
...
$(document).keydown(function(event){if(event.keyCode==123){return!1}else if((event.ctrlKey&&event.shiftKey&&event.keyCode==73)||(event.ctrlKey&&event.shiftKey&&event.keyCode==74)){return!1}})
